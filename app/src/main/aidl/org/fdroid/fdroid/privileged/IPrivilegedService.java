 ...
 * Original file: vendor/spt/fdroid-privileged-extension/aidl/org/fdroid/fdroid/privileged/IPrivilegedService.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_hasPrivilegedPermissions, _data, _reply, 0);
...
mRemote.transact(Stub.TRANSACTION_installPackage, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
_data.writeInt(flags);
_data.writeStrongBinder((((callback!=null))?(callback.asBinder()):(null)));
mRemote.transact(Stub.TRANSACTION_deletePackage, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
