...
class SerialService : Service(), SerialListener {
    ...
    private fun createNotification() {
        ...
        val builder = NotificationCompat.Builder(this, NOTIFICATION_CHANNEL)
            .setSmallIcon(R.drawable.ic_round_usb_24)
        ...
        // @drawable/ic_round_usb_24 created with Android Studio -> New -> Image Asset using @color/colorPrimaryDark as background color
